...
规范性检测、论文相似度检测、论文润色、创新性量表评估和规则化辅助评阅在侧边栏中各保留一个模块入口。用户进入模块后，通过同一页面区域内的页签切换“发起功能”和“历史记录”；论文润色提供“整篇润色”“局部润色”“润色记录”三个页签。报告详情可以保留独立 URL，旧历史地址继续可访问，切换到历史页或详情页时侧边栏仍高亮所属业务模块。
