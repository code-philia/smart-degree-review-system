...
export default function StudentReportSubmissionPage() {
  ...
  return (
    <div className="text-slate-900">
      <PageHeader title="学生报告提交与批阅结果台账" />

      <section className="flex items-center gap-3 rounded-xl border border-slate-200 bg-slate-100 px-5 py-4">
      ...
      <section className="mt-6 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
        <div className="flex items-center justify-between border-b border-slate-200 px-5 py-4">
          <h2 className="text-xl font-bold text-slate-900">可提交报告</h2>
          <button
            type="button"
