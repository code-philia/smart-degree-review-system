...
const AVAILABLE_CAPABILITIES = [
  { title: '基础规则检测', text: '按当前生效规则检查章节顺序、标点配对、参考文献和禁用词等问题，并定位到具体行列。' },
  {
    title: 'PDF 语义规则审查',
    text: '服务器配置模型密钥后，可按需使用 DeepSeek 检查中英文摘要一致性、数值论点与论据矛盾及强论断支撑；只发送规则选中的相关文本，结果必须人工复核。',
  },
  { title: '高级语义规则检测', text: '提供论点论据不一致、论文新颖性与相关对比工作推荐三个固定示例，结果仅供人工复核。' },
    ...
    <div>
      ...
      <Card className="mt-5" title="数据范围说明">
        <p className="text-sm leading-6 text-slate-600">
          试用账号下预置的论文、检测、评阅和统计记录均为脱敏构造的试点样例，用于演示角色权限与业务流转，不代表真实学生论文或正式评价结论。相似度检测所依据的比对样本库范围有限，仅覆盖试点阶段导入的样本，尚不能代表全校正式论文库。
        </p>
      </Card>
